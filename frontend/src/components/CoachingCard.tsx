    ...
    <div className="space-y-4">
      ...
      {strengths.length > 0 && (
        <section className="bg-white rounded-2xl border border-cv-warm-200 overflow-hidden">
          {/* Header */}
          <div className="flex items-center gap-2.5 px-5 py-3.5 border-b border-cv-warm-100 bg-cv-teal-50">
            ...
            <h3 className="text-sm font-semibold text-cv-teal-800">{STRINGS.coachingCard.strengthsHeading}</h3>
          </div>
      ...
      {focus && (
        <section className="bg-white rounded-2xl border border-cv-warm-200 overflow-hidden">
          {/* Header */}
          <div className="flex items-center gap-2.5 px-5 py-3.5 border-b border-cv-warm-100 bg-cv-amber-50">
            <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-cv-amber-600 shrink-0" aria-hidden="true">
              <path d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
              <path fillRule="evenodd" d="M.664 10.59a1.651 1.651 0 010-1.186A10.004 10.004 0 0110 3c4.257 0 7.893 2.66 9.336 6.41.147.381.146.804 0 1.186A10.004 10.004 0 0110 17c-4.257 0-7.893-2.66-9.336-6.41zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clipRule="evenodd" />
            </svg>
            <h3 className="text-sm font-semibold text-cv-amber-800">{STRINGS.coachingCard.focusHeading}</h3>
          </div>
