 ...
 *
 * Design:
 *   - Target speaker: cv-teal-50 background with a 3px solid cv-navy-600 left bar
...
export function EvidenceQuote({ quote, targetSpeaker }: EvidenceQuoteProps) {
  ...
  const blockStyles = isOtherSpeaker
    ...
    : 'border-l-[3px] border-cv-navy-600 pl-4 pr-3 py-2.5 my-2 bg-cv-teal-50 rounded-r';
