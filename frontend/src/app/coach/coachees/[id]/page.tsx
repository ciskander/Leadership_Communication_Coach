      ...
      <div>
        ...
        <div className="flex items-start justify-between mt-2">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-cv-teal-600 text-white rounded-xl text-sm font-medium hover:bg-cv-teal-700 transition-colors shadow-sm"
          >
